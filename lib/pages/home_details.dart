          ...
          children: [
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    catalog.name.text.white.xl4.bold.make(),// 5:41
                    catalog.desc.text.yellow100.xl.make(),
                    ":oream ispmum addad adasd kjljsadi akljdaekl adkjlkjlkdja kjdakjd dakdjalk adkajlkda akljajda kljad".text.yellow100.xl.make().p16(),
                  ],
                ).py64(),
              ),
            ))
